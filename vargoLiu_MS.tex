...
\begin{center}
\begin{tabular}{c}
\includegraphics[totalheight=0.6\textheight]{../../images/stations_table_ATL.pdf} 
\end{tabular}
\label{tab:ATLstats}
\end{center}
\end{table}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[totalheight=0.71\textheight, angle=90]{../../images/stations_table_CHI.pdf} 
\end{tabular}
\label{tab:CHIstats}
\end{center}
\end{table}
...
\begin{center}
\begin{figure}[t]
 \includegraphics[scale=0.84]{../../images/advisories.pdf}
